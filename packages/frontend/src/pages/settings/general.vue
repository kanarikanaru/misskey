	...
	<FormSection>
		...
		<div class="_gaps_m">
			<div class="_gaps_s">
				...
				<MkSwitch v-model="allowReactionsBeams">{{ i18n.ts.allowReactionsBeams }}</MkSwitch>
...
const allowReactionsBeams = computed(defaultStore.makeGetterSetter('allowReactionsBeams'));
