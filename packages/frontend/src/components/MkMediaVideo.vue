...
<template>
<div v-if="hide" :class="[$style.hidden, (video.isSensitive && defaultStore.state.highlightSensitiveMedia && defaultStore.state.enableDataSaverMode) && $style.sensitiveContainer]" @click="hide = false">
...
<div v-else :class="[$style.visible, (video.isSensitive && defaultStore.state.highlightSensitiveMedia && defaultStore.state.enableDataSaverMode) && $style.sensitiveContainer]">
	<video
		ref="videoEl"
		:class="$style.video"
